...
namespace TeeknikServis.Formlar
{
    public partial class FrmCariİller : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-SF55IDA;Initial Catalog=DbTeknikServis;Integrated Security=True");
        ...
        private void FrmCariİller_Load(object sender, EventArgs e)
        {
          ...
          //  chartControl1.Series["Series 1"].Points.AddPoint("İstanbul", 14);
           // chartControl1.Series["Series 1"].Points.AddPoint("Bursa", 15);
